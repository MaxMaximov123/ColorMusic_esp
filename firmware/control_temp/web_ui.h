...
h1{font-size:1.4rem;text-align:center;padding:12px 0 4px;color:#e8912e}
...
.sec h2{font-size:.8rem;color:#e8912e;margin-bottom:10px;text-transform:uppercase;letter-spacing:.05em}
...
.nets button:active{border-color:#e8912e;color:#e8912e}
...
input:focus{border-color:#e8912e}
...
.btn.go{background:#e8912e;color:#111}
.btn.scan{background:#1a1a2e;color:#e8912e;border:1px solid #e8912e}
...
<p class="info">Двойное нажатие кнопки FLASH = сброс WiFi и сервера</p>
